/* specrend.c    2022-05-25 */

/* Copyright 2003 John Walker, ported to R by Emmanuel Paradis */
...
void spectrum_to_xyz_2(double *spec_intens, double *x, double *y, double *z)
{
    int i;
    double lambda, X = 0, Y = 0, Z = 0, XYZ, Me;
...
void C_specrend(double *spec_intens, double *R, double *G, double *B, int *approx, int *color_system)
{
    ...
    switch (*color_system) {
    case 1 : cs = &NTSCsystem; break;
    case 2 : cs = &EBUsystem; break;
    case 3 : cs = &SMPTEsystem; break;
    case 4 : cs = &HDTVsystem; break;
    case 5 : cs = &CIEsystem; break;
    case 6 : cs = &Rec709system; break;
    }

    spectrum_to_xyz_2(spec_intens, &x, &y, &z);
    xyz_to_rgb(cs, x, y, z, &r, &g, &b);
    *approx = constrain_rgb(&r, &g, &b);
    norm_rgb(&r, &g, &b);
    *R = r; *G = g; *B = b;
}
